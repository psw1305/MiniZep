...
public class NPC : MonoBehaviour, ICharacter
{
    ...
    private void Start()
    {
        ...
        //var communityNameObj = Main.Resource.Instantiate("UI_Community_Name", Main.Game.CommunityList);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            //Main.Game?.MainUI.ActiveDialogueButton(true, npcBlueprint);
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            //Main.Game?.MainUI.ActiveDialogueButton(false);
            outlineSprite.color = Color.clear;
        }
    }
}
